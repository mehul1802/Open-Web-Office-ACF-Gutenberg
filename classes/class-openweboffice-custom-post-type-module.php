                ...
                if( have_rows("add_custom_post_type","option") ):
                    ...
                    while ( have_rows("add_custom_post_type","option") ) : the_row();	
                        ...
                        $labels = array_merge(
                            // Default
                            array(
                                "name"                  => _x( $plural , "post type general name", "open-web-office-acf-gutenberg" ),
                                "singular_name"         => _x( $name, "post type singular name", "open-web-office-acf-gutenberg" ),
                                "add_new"               => _x( "Add New", strtolower( $name ), "open-web-office-acf-gutenberg" ),
                                "add_new_item"          => __( "Add New " . $name, "open-web-office-acf-gutenberg" ),
                                "edit_item"             => __( "Edit " . $name, "open-web-office-acf-gutenberg" ),
                                "new_item"              => __( "New " . $name, "open-web-office-acf-gutenberg" ),
                                "all_items"             => __( "All " . $plural, "open-web-office-acf-gutenberg" ),
                                "view_item"             => __( "View " . $name, "open-web-office-acf-gutenberg" ),
                                "search_items"          => __( "Search " . $plural, "open-web-office-acf-gutenberg" ),
                                "not_found"             => __( $no_found, "open-web-office-acf-gutenberg"),
                                "not_found_in_trash"    => __( $not_found_in_trash, "open-web-office-acf-gutenberg"), 
                                "parent_item_colon"     => "",
                                "menu_name"             => $plural
                            ),
                        );
                            ...
                            if( have_rows("custom_taxonomies","option") ):
                                ...
                                while ( have_rows("custom_taxonomies","option") ) : the_row();	
                                    ...
                                    $taxonomy_labels = array(
                                        "name"                  => _x( $taxonomy_plural, "taxonomy general name", "open-web-office-acf-gutenberg" ),
                                        "singular_name"         => _x( $taxonomy_name, "taxonomy singular name", "open-web-office-acf-gutenberg" ),
                                        "search_items"          => __( "Search " . $taxonomy_plural, "open-web-office-acf-gutenberg" ),
                                        "all_items"             => __( "All " . $taxonomy_plural, "open-web-office-acf-gutenberg" ),
                                        "parent_item"           => __( "Parent " . $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                        "parent_item_colon"     => __( "Parent " . $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                        "edit_item"             => __( "Edit " . $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                        "update_item"           => __( "Update " . $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                        "add_new_item"          => __( "Add New " . $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                        "new_item_name"         => __( "New " . $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                        "menu_name"             => __( $taxonomy_name, "open-web-office-acf-gutenberg" ),
                                    );
