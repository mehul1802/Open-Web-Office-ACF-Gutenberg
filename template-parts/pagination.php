<?php
/**
 * A template partial to output pagination for the Open Web Office default theme.
 *
...
$prev_text = sprintf(
	...
	__( 'Newer <span class="nav-short">Posts</span>', 'open-web-office-acf-gutenberg' )
);
$next_text = sprintf(
	'<span class="nav-next-text">%s</span> %s',
	__( 'Older <span class="nav-short">Posts</span>', 'open-web-office-acf-gutenberg' ),
