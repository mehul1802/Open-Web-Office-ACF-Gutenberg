...
<main id="site-content" role="main">
	...
	if ( is_search() ) {
		...
		if ( $wp_query->found_posts ) {
			...
			$search_subtitle = __( 'We could not find any results for your search. You can give it another try through the search form below.', 'open-web-office-acf-gutenberg' );
		}
	} 
